...
source_location = gp.SourceLocation(
    source_location_x = jnp.array(55.5),
    source_location_y = jnp.array(55.5),
...
wind_field = gp.WindField(
    ...
    number_of_time_steps = jnp.array(10_000),
...
sensors_settings =  gp.SensorsSettings(
    ...
    sensor_locations =  [[12,12], [24, 24], [48,48], [60,60], [78,78], [96,96], [108,108], [120,120], [48,24], [24,48],[24,72], [72,96],
                        [72,24], [24,96], [96,24], [96,48], [48,96], [96,72], [72,96], [36,81], [81,36], [48,72], [72,48], [48,84],
                        [84,48], [42,48], [48,42], [36,12], [12,36], [36,60], [60,36]], 
)
